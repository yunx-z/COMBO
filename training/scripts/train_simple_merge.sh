...
#SBATCH --job-name=tqa_sample_10gpt_10dpr_large_simple_merge_seed233
...
##SBATCH --dependency=afterany:52105305
...
TRAIN_FILE="${DATA_DIR}/tqa_sample_10gpt_10dpr_train.jsonl"
EVAL_FILES="${DATA_DIR}/tqa_sample_10gpt_10dpr_dev.jsonl"
TEST_FILES="${DATA_DIR}/tqa_sample_10gpt_10dpr_test.jsonl"
SAVE_DIR=${DATA_DIR}/experiments/
EXPERIMENT_NAME=tqa_sample_10gpt_10dpr_large_simple_merge
TRAIN_STEPS=5000
EVAL_STEPS=500
TEXT_MAX_LEN=200
N_CTX=20

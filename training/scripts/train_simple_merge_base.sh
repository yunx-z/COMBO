...
#SBATCH --job-name=nq_sample_10gpt_10dpr_base_simple_merge_seed10
...
TRAIN_FILE="${DATA_DIR}/nq_sample_10gpt_100dpr_train.jsonl"
EVAL_FILES="${DATA_DIR}/nq_sample_10gpt_100dpr_dev.jsonl"
TEST_FILES="${DATA_DIR}/nq_sample_10gpt_100dpr_test.jsonl"
SAVE_DIR=${DATA_DIR}/experiments/
EXPERIMENT_NAME=nq_sample_10gpt_10dpr_base_simple_merge
TRAIN_STEPS=10000
EVAL_STEPS=1000
TEXT_MAX_LEN=200
N_CTX=20

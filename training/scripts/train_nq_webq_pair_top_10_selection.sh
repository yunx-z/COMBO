...
#SBATCH --job-name=nq_sample_10gpt_20dpr_large_pair_compatibility_2stage_optimal_unified_seed42
...
TRAIN_FILE="${DATA_DIR}/merge/nq/sample_10gpt_20dpr/compatibility_2stage_optimal_unified/train.jsonl"
EVAL_FILES="${DATA_DIR}/merge/nq/sample_10gpt_20dpr/compatibility_2stage_optimal_unified/dev.jsonl"
TEST_FILES="${DATA_DIR}/merge/nq/sample_10gpt_20dpr/compatibility_2stage_optimal_unified/test.jsonl"
SAVE_DIR=${DATA_DIR}/experiments/
EXPERIMENT_NAME=nq_sample_10gpt_20dpr_large_pair_compatibility_2stage_optimal_unified_lr${LR}
TRAIN_STEPS=5000
EVAL_STEPS=500
N_CTX=10
SEED=42

...
#SBATCH --job-name=hotpotqa_sample_10gpt_large_seed23
...
##SBATCH --dependency=afterany:52235305
...
TRAIN_FILE="${DATA_DIR}/hotpotqa_sample_10gpt_50dpr_train.jsonl"
EVAL_FILES="${DATA_DIR}/hotpotqa_sample_10gpt_50dpr_dev.jsonl"
TEST_FILES="${DATA_DIR}/hotpotqa_sample_10gpt_50dpr_test.jsonl"
SAVE_DIR=${DATA_DIR}/experiments/
EXPERIMENT_NAME=hotpotqa_sample_10gpt_large
TRAIN_STEPS=10000
EVAL_STEPS=1000
TEXT_MAX_LEN=400
N_CTX=10

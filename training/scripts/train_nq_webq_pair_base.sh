...
#SBATCH --job-name=nq_sample_10gpt_10dpr_base_pair_random_seed10
...
TRAIN_FILE="${DATA_DIR}/merge/nq/sample_10gpt_10dpr/random/train.jsonl"
EVAL_FILES="${DATA_DIR}/merge/nq/sample_10gpt_10dpr/random/dev.jsonl"
TEST_FILES="${DATA_DIR}/merge/nq/sample_10gpt_10dpr/random/test.jsonl"
SAVE_DIR=${DATA_DIR}/experiments/
EXPERIMENT_NAME=nq_sample_10gpt_10dpr_base_pair_random_lr${LR}
TRAIN_STEPS=10000
EVAL_STEPS=1000
N_CTX=50
SEED=10

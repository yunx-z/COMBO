...
#SBATCH --job-name=webq_sample_10gpt_large_seed23
...
TRAIN_FILE="${DATA_DIR}/webq_sample_10gpt_10dpr_train.jsonl"
EVAL_FILES="${DATA_DIR}/webq_sample_10gpt_10dpr_dev.jsonl"
TEST_FILES="${DATA_DIR}/webq_sample_10gpt_10dpr_test.jsonl"
SAVE_DIR=${DATA_DIR}/experiments/
EXPERIMENT_NAME=webq_sample_10gpt_large
TRAIN_STEPS=10000
EVAL_STEPS=500
TEXT_MAX_LEN=200
N_CTX=10
